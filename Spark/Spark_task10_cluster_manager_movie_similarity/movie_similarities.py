# Spark_task10_movie_similarity: determine movie similarity base on aggregated 
# user behavior
...
# Main 
# Create Spark Session, use all core on the local system
...
movieNames = spark.read \
      ...
      .csv("hdfs/projects/ml-100k/u.item")

# Load up movie data as dataset
movies = spark.read \
      .option("sep", "\t") \
      .schema(moviesSchema) \
      .csv("hdfs/projects/ml-100k/u.data")
...
# Create unique movieID pairs, join pair rated by the same userID
...
if (len(sys.argv) > 1):
    ...
    # Filter for movies similarity score above 97%
    ...
    for result in results:
        ...
        #print movie name, score and strength
